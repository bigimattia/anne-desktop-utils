...
object AppLocalizations {
    private val italian = AppStrings(
        ...
        hotkeyDescription = "Usa le scorciatoie configurate per cambiare desktop. Su Windows e macOS, aggiungi Maiusc per spostare la finestra attiva quando la scorciatoia non include gia Maiusc.",
        status = "Stato",
        active = "Attivo",
        inactive = "Non attivo",
    ...
    private val english = AppStrings(
        ...
        hotkeyDescription = "Use the configured shortcuts to switch desktops. On Windows and macOS, add Shift to move the active window when the shortcut does not already include Shift.",
        status = "Status",
        active = "Active",
        inactive = "Inactive",
